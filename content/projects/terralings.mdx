...
<Callout>
⚡ **In-Browser WebAssembly Learning Platform**: Practice all 68 exercises across 15 chapters directly in your browser with zero installation—powered by Pyodide (Python 3.12 Wasm), Monaco Editor, AST evaluation, and local progress persistence.

👉 [**Launch WebAssembly Playground (15 Chapters · 68 Exercises) →**](https://dnf0.github.io/terralings/playground/)
</Callout>

**Terralings** is an ultra-fast, interactive terminal learning tool for mastering Terraform and OpenTofu from scratch. Inspired by [Rustlings](https://github.com/rust-lang/rustlings), [Spanglings](https://github.com/dnf0/spanglings), and [Raylings](https://github.com/dnf0/raylings), it guides engineers through fixing broken configurations, writing declarative Infrastructure as Code (IaC), mastering HCL functions, refactoring state with `moved` blocks, authoring `.tftest.hcl` tests, configuring OpenTofu state encryption, and building multi-cloud AWS & GCP architecture blueprints.
...
- **High-Performance Go Binary**: The entire 68-exercise curriculum is embedded directly into a standalone binary with zero runtime dependencies.
...
### Curriculum Matrix (15 Chapters · 68 Exercises)
...
- **14–15 Cloud Architecture Blueprints**: AWS multi-AZ VPC networking, resilient compute, serverless pipelines, SNS/SQS async decoupling, zero-trust IAM, and GCP custom VPCs, regional MIGs, Cloud Run, Pub/Sub, and Workload Identity federation.

### Links & Resources

- [⚡ Launch WebAssembly Playground](https://dnf0.github.io/terralings/playground/)
