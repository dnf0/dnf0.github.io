...
tags: ["rust", "tui", "ratatui", "lsp", "language-learning", "lings", "cli", "wasm", "monaco"]
---

<Callout>
⚡ **In-Browser WebAssembly Learning Platform & Rapid Arcade**: Practice all 136 sentence frames across 24 grammar topics, battle through 16 duel showdowns, and drill 5 specialized engines directly in your browser with zero installation—powered by Rust WebAssembly, Monaco Editor, dual-layer communicative/structural explanations, and SM-2 spaced repetition.

👉 [**Launch WebAssembly Playground & Arcade (24 Topics · 136 Frames) →**](https://dnf0.github.io/spanglings/playground/)
</Callout>
...
- [⚡ Launch WebAssembly Playground & Arcade](https://dnf0.github.io/spanglings/playground/)
- [📖 Documentation & Reference Manual](https://dnf0.github.io/spanglings/)
