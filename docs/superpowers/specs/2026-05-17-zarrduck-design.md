# Zarrduck - Design Spec

## Overview
Add a new project showcase page to the `/projects` section of the portfolio for the `zarrduck` GitHub repository. This will use the "Curated Overview Page" approach, leveraging the existing MDX rendering pipeline.

## File Structure
- Directory to be created: `content/projects/`
- New file: `content/projects/zarrduck.mdx`
...
2. **Links Section**:
   - Primary Repository Link: `https://github.com/dnf0/zarrduck`
   - README Link: `https://github.com/dnf0/zarrduck#readme`

## Implementation Steps
1. Create the `content/projects` directory.
2. Author the `zarrduck.mdx` file.
